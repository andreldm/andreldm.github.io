...
path = "2020/11/19/xfce4.16pre2.html"
...
Similary to pre1, you can either manually compile the [tarballs](https://archive.xfce.org/xfce/4.16pre2/src/) or use [xfce-test](https://github.com/schuellerf/xfce-test) (`ubuntu_20.04-xfce-4.16pre2` tag should be available at any moment) to enjoy a safe preview of Xfce 4.16. See the previous [post](/2020/09/12/xfce4.16pre1.html#where-can-you-get-it) for more options.
